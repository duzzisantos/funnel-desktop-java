 ...
 * @author user
 */
public class CampaignsTable extends javax.swing.JFrame {

    /**
     * Creates new form CampaignsTable
     */
    public CampaignsTable() {
     ...
     EntityManager em = emf.createEntityManager();
         ...
         TypedQuery<Campaigns> query = em.createQuery("SELECT item FROM Campaigns item", Campaigns.class);
    ...
    private void generateTableRows(){
        ...
        for(Campaigns mgr: CAMPAIGNS){
            model.addRow( new Object[] {
                mgr.getCampaignName(),
                mgr.getCampaignType(),
                mgr.getCampaignManager(),
                mgr.getAccountManagerId(),
                mgr.getCampaignStart(),
                mgr.getCampaignEnd(),
                mgr.getCampaignProduct(),
                mgr.getProductId(),
                mgr.getCampaignSalesValueTarget(), mgr.getCampaignSalesVolumeTarget(),
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Type", "Manager", "Manager ID", "Start Date", "End Date", "Product", "Product ID", "Sales Value Target", "Sales Volume Target"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CampaignsTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CampaignsTable().setVisible(true);
            }
        });
    }
